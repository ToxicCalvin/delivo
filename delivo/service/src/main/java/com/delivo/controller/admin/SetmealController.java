...
public class SetmealController {
     ...
     */
    @DeleteMapping
    @ApiOperation("Batch Delete Setmeals")
    ...
    @ApiOperation("Enable/Disable Setmeal Sale")
    @CacheEvict(cacheNames = "setmealCache",allEntries = true)
