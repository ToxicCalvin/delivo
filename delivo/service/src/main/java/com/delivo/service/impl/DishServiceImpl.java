...
public class DishServiceImpl implements DishService {
    ...
    public void saveWithFlavor(DishDTO dishDTO) {
        ...
        // Invalidate AI embedding cache so the next startup re-embeds with the new dish.
        DishVectorStoreLoader.invalidateCache();
    }
    ...
    public void startOrStop(Integer status, Long id) {
        ...
        // Status changes affect which dishes are indexed (queries use status=1 only)
        DishVectorStoreLoader.invalidateCache();
    }
